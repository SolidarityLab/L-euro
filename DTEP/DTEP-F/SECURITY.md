...
DTEP-F is currently in specification phase (v0.1-draft). The reference implementation is not yet in production deployment.
...
CSDT takes security issues in DTEP-F seriously. We appreciate responsible disclosure.

**Private reporting channel:**
security@solidaritylab.eu

Alternatively, use GitHub Security Advisories:
https://github.com/SolidarityLab/dtep-f/security/advisories/new
...
2. CSDT acknowledges within 72 hours
3. CSDT assesses severity and scope within 7 days
4. Fix or mitigation developed in coordination with reporter
5. Public disclosure after fix is available — typically within 90 days of initial report
6. Reporter credited in the security advisory unless anonymity is requested
...
See [docs/threat-model.md](docs/threat-model.md) Section 6 for the full out-of-scope definition.
